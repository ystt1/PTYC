...
import '../../../domain/medicine/usecase/delete_medical_usecase.dart';

void deleteMedical(BuildContext context, String medicalId) {
  showDialog(
    context: context,
                ...
                return TextButton(
                  ...
                  onPressed: () {
                    context.read<ButtonStateCubit>().execute(
                        usecase: DeleteMedicalUseCase(), params: medicalId);
                  },
                );
              }),
            ],
