...
import '../../../domain/doctor/usecase/delete_doctor_usecase.dart';



void deleteDoctor(BuildContext context, String doctorId) {
  showDialog(
    context: context,
                ...
                return TextButton(
                  ...
                  onPressed: () {
                    context.read<ButtonStateCubit>().execute(
                        usecase: DeleteDoctorUseCase(), params: doctorId);
                  },
                );
              }),
            ],
